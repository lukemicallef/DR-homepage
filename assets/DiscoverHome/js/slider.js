jQuery(document).ready(function($){
	...
	function animateHeroSlider() {
		...
		setInterval(function(){
			...
			var navClass = $(".cd-slider-nav span").attr("class");
			var listNumber = parseInt(navClass.substring(navClass.length - 1,navClass.length));
			var listLength = $(".cd-slider-nav ul").children().length;
			...
			var currentItem = $(".cd-slider-nav .selected a");
			$('#find-out-more-btn').attr('href', currentItem.data('url'));
	...
	if ( $('.cd-slider-nav').length) { animateHeroSlider() }


	$(".cd-slider-nav a").click(function() {
		var selectedItem = $(this);
		$('#find-out-more-btn').attr('href', selectedItem.data('url'))
	});
